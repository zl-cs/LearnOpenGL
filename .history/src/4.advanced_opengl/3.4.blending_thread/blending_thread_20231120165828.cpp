...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        while (true) {
            ...
            // glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, viewport[2], viewport[3], 0, GL_RGB, GL_UNSIGNED_BYTE, val.data());
            // glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
            // glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);

            // // Create a framebuffer and attach the texture as a color attachment
            // GLuint framebuffer;
            ...
            // // Render the texture to the screen-space quad
