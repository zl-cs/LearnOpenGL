...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // test rendering time
        clock_t start,end,cube,floor,window,queue; //定义clock_t变量
        start = clock(); 
        ...
        cout << "window time = " << double(window-floor)/CLOCKS_PER_SEC << "s" << endl;
        cout << "queue time = " << double(queue-window)/CLOCKS_PER_SEC << "s" << endl;
