...
void window_rendering(int i,GLint width, GLint height){
    ...
    Shader shader("/home/zhang/code/LearnOpenGL/src/4.advanced_opengl/3.4.blending_thread/3.2.blending.vs", "/home/zhang/code/LearnOpenGL/src/4.advanced_opengl/3.4.blending_thread/3.1.window_blending.fs");
