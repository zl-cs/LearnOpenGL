...
int main()
{
    ...
    Shader screenShader("/home/zhang/code/LearnOpenGL/src/4.advanced_opengl/3.4.blending_thread/5.1.framebuffers_screen.vs", "src/4.advanced_opengl/3.4.blending_thread/5.0.framebuffers_screen.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // std::cout << "Currently bound FBO: " << currentFBO << std::endl;
        // GLint alphaBits;
        ...
        std::cout << "Alpha bits: " << alphaBits << std::endl;
        ...
        if (whole_pixels.size() >= 4) {
            ...
            std::cout << "Alpha bit of initial texture: " << static_cast<int>(alpha) << std::endl;
        } else {
            std::cout << "Not enough data for an RGBA pixel" << std::endl;
        }
        write_png_area(whole_pixels, i, viewport[2],viewport[3], "before_mix");
        for (const auto& pair : myMap) {
            ...
            if (whole_pixels.size() >= 4) {
                unsigned char alpha = whole_pixels[3];
                std::cout << "Alpha bit of loaded texture: " << static_cast<int>(alpha) << std::endl;
            } else {
                std::cout << "Not enough data for an RGBA pixel" << std::endl;
            }
