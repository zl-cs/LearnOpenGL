...
int main()
{
    ...
    Shader screenShader("src/4.advanced_opengl/3.4.blending_thread/5.1.framebuffers_screen.vs", "src/4.advanced_opengl/3.4.blending_thread/5.0.framebuffers_screen.fs");
