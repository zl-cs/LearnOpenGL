...
int main()
{
    ...
    Shader screenShader2("/home/zhang/code/LearnOpenGL/src/4.advanced_opengl/3.4.blending_thread/3.2.blending.fs", "/home/zhang/code/LearnOpenGL/src/4.advanced_opengl/3.4.blending_thread/3.1.window_blending.fs");
...
void window_rendering(int i,GLint width, GLint height){
    ...
    // glBlendFunc(GL_ONE, GL_ONE);  //增强
    //glBlendFunc(GL_SRC_ALPHA, GL_DST_ALPHA); //镂空
    ...
    for (std::map<float, glm::vec3>::reverse_iterator it = sorted.rbegin(); it != sorted.rend(); ++it)
    {
        ...
        glDrawArrays(GL_TRIANGLES, 0, 6);
        // 
        // std::cout << "******* Draw window : " << z <<std::endl;
    }
